...
class MessageModel(BaseModel):
    message: str = Field(
        ..., 
        description="The message to send to the agent for processing.",
...
async def invoke_agent(message_model: MessageModel):

    print(f"Received message: {message_model.message}")
